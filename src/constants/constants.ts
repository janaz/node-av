...
// libavutil/pixfmt.h
export type AVAlphaMode = number & { readonly [__ffmpeg_brand]: 'AVAlphaMode' };

export const AVALPHA_MODE_UNSPECIFIED = 0 as AVAlphaMode;
...
// FF_ value constants for AVCodecContext/AVFrame option values and fields (98 constants)
export const FF_BUG_AMV = 32;
export const FF_BUG_AUTODETECT = 1;
...
export const FF_CODEC_PROPERTY_CLOSED_CAPTIONS = 2;
export const FF_CODEC_PROPERTY_FILM_GRAIN = 4;
export const FF_CODEC_PROPERTY_LOSSLESS = 1;
export const FF_COMPLIANCE_EXPERIMENTAL = -2;
export const FF_COMPLIANCE_NORMAL = 0;
export const FF_COMPLIANCE_STRICT = 1;
export const FF_COMPLIANCE_UNOFFICIAL = -1;
export const FF_COMPLIANCE_VERY_STRICT = 2;
...
export const FF_DCT_NEON = 7;
export const FF_DEBUG_BITSTREAM = 4;
export const FF_DEBUG_BUFFERS = 32768;
export const FF_DEBUG_BUGS = 4096;
export const FF_DEBUG_DCT_COEFF = 64;
export const FF_DEBUG_ER = 1024;
export const FF_DEBUG_GREEN_MD = 8388608;
export const FF_DEBUG_MB_TYPE = 8;
export const FF_DEBUG_MMCO = 2048;
export const FF_DEBUG_NOMC = 16777216;
export const FF_DEBUG_PICT_INFO = 1;
export const FF_DEBUG_QP = 16;
export const FF_DEBUG_RC = 2;
export const FF_DEBUG_SKIP = 128;
export const FF_DEBUG_STARTCODE = 256;
export const FF_DEBUG_THREADS = 65536;
...
export const FF_LAMBDA_MAX = 32767;
export const FF_LAMBDA_SCALE = 128;
export const FF_LAMBDA_SHIFT = 7;
export const FF_LOSS_ALPHA = 8;
export const FF_LOSS_CHROMA = 32;
export const FF_LOSS_COLORQUANT = 16;
export const FF_LOSS_COLORSPACE = 4;
export const FF_LOSS_DEPTH = 2;
export const FF_LOSS_EXCESS_DEPTH = 128;
export const FF_LOSS_EXCESS_RESOLUTION = 64;
export const FF_LOSS_RESOLUTION = 1;
...
export const FF_QUALITY_SCALE = 128;
